# Keelson Connector Hand controller - ROV
...
[DATASHEET.pdf](./doc/SSROV-HC-DATASHEET.pdf)

[MANUAL.pdf](./doc/SSROV-HC-MANUAL.pdf)
...
# UDP
socat -u UDP4-RECV:2033,reuseaddr STDOUT | bin/main --log-level 10 -r rise -e controllstation
...
============================================================
Seascape ROV Hand Controller - Serial Reader (PySerial)
============================================================
Port:     /dev/ttyACM1
Baud:     115200
Timeout:  1.0s
